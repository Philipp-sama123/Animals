...
namespace MalbersAnimations.Selector
{
    ...
    public partial class SelectorController
    {
        ...
        {
            ChangeInputDirection(InputDir.Left);
        }

        public virtual void ChangeRight()
        {
            ChangeInputDirection(InputDir.Right);
        }

        public virtual void ChangeUp()
        {
            ChangeInputDirection(InputDir.Up);
        }

        public virtual void ChangeDown()
        {
            ChangeInputDirection(InputDir.Down);
        }
        ...
        public virtual void ChangeLeft_Input()
        {
